...
def main():
    ...
    df_payment, df_customer, df_address, df_country, df_city, df_store, df_staff, df_rental = run_extract()
    run_load(df_payment, df_customer, df_address, df_country, df_city, df_store, df_staff, df_rental)
    run_dbt()
